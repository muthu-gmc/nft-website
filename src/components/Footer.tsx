        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-y-10 gap-x-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="#" className="hover:text-orange-500 transition-colors">EAM Strategy</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">CMMS Implementation</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">IoT Integration</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Industry Solutions</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Consulting Services</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Blog & News</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Case Studies</Link></li>
